    ...
    <x-container>
        ...
        <div  class="block mt-2 rounded-lg bg-gray-400 p-6 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">  
            <div class="flex justify-between">
                <div>
                    <x-link href="{{ route('users.index') }}" class="bg-indigo-600">
                    ...
                    <x-link href="{{-- route('users.edit', $user->id) --}}" class="bg-green-500">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                ...
                <x-form action="{{-- route( 'users.destroy', $permission->id ) --}}" method="DELETE">      
